...
df1 = pd.read_csv('dados_aguas_65015400.txt', sep=' ', decimal=',', na_values='-', header=None).rename(columns={1:'year',2:'month',3:'day'})
df1 = df1.set_index(pd.to_datetime(df1[['year','month','day']]))[[6,7]].copy()
srh1 = df1[6]
srq1 = df1[7]

# 2 - Serie do SNIRH (telemetrica)
df2 = pd.read_csv('telemetria_SNIRH_65015400.csv')
...
srh = srh.truncate(before='2013-09-15')
srh = srh.round(2)
srh.to_csv('srh_65015400_2020_05_31.csv', header=True, index_label='data')
